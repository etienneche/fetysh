...
ActiveRecord::Schema.define(version: 2019_11_26_104329) do
  ...
  create_table "user_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["subcategory_id"], name: "index_user_categories_on_subcategory_id"
  ...
  add_foreign_key "user_categories", "subcategories"
